...
func NewLimitOrder(user_id int64, trade_symbol string, side orderSide, price, qty string) (order_id string, err error) {
	return limit_order(user_id, trade_symbol, side, price, qty)
}

func limit_order(user_id int64, trade_symbol string, side orderSide, price, qty string) (order_id string, err error) {
